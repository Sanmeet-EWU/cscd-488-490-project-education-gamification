...
export class BaseScene extends Scene {
    ...
    handleResize(gameSize) {
        ...
        if (this.cameras?.main) {
            ...
            console.warn(`Camera not initialized yet in ${this.sceneKey}.`);
            return;
        }

        // Do not call setGameSize here; ScaleManager handles it
        if (this.repositionUI) this.repositionUI({ width: newWidth, height: newHeight });
    }
