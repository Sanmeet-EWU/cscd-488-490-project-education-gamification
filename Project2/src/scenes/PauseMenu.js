...
export class PauseMenu extends Scene
{
    ...
    init (gameScene)
    {
        this.gameScene = gameScene;//the game scene that is being paused
    }

    create ()
    {
        console.log("PauseMenu created");
        this.makeOptionsButton(this.gameScene);
    ...
    makeOptionsModal(gameScene){
        ...
        this.closeButton.on('pointerdown', () => {
            this.optionsModal.setVisible(false);
            this.optionsButton.setVisible(true);
            //this.scene.resume();//This will need to grab the current scene running in parallel and resume it
            gameScene.scene.resume();
        });
