...
export class Act5Scene7 extends BaseGameScene {
    ...
    preload() {
        ...
        // Scene music
        this.load.audio('act5scene7music', 'assets/audio/act5scene7music.mp3');
    ...
    create(data) {
        ...
        const requiredAssets = [
            'background_act5scene7', 'macbeth', 'youngSiward', 'act5scene8part1music',
            'Macbeth', 'YoungSiward'
        ];
    ...
    setupSceneDialogue() {
        if (!this.cache.json.exists('Act5Scene7Data')) return;
    ...
    onResize(gameSize) {
        if (!this.scene.isActive('Act5Scene7')) return; // REPLACE: Scene key
