...
export class Act5Scene3 extends BaseGameScene {
    ...
    preload() {
        ...
        // Scene music
        this.load.audio('act5scene3music', 'assets/audio/act5scene3music.mp3');
    ...
    create(data) {
        ...
        const requiredAssets = [
            'background_act5scene3', 'macbeth', 'doctor', 'attendant', 'act5scene3music',
            'Macbeth', 'Doctor', 'Attendant'
        ];
    ...
    setupSceneDialogue() {
        if (!this.cache.json.exists('Act5Scene3Data')) return;
    ...
    onResize(gameSize) {
        if (!this.scene.isActive('Act5Scene3')) return; // REPLACE: Scene key
